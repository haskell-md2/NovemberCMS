...
<body>
	...
	<header>
		<h2><a href="#">{{$snippets->getSnipp('лого')}}</a></h2>
		<nav>
			<li><a href="#">Home</a></li>
	...
	<section class="hero">
		...
		<h1>{{$snippets->getSnipp('слоган')}}</h1>
		<h3>A freebie by Tutorialzine.</h3>
		<a href="http://tutorialzine.com/2016/06/freebie-landing-page-template-with-flexbox/" class="btn">{{$snippets->getSnipp('start')}}</a>
	</section>
